                ...
                <div className='max-w-7xl mx-auto px-4 sm:px6 lg:px8'>
                    <div className='flex items-center space-x-4'>
                        ...
                        <Activity mode={usuario?.email ? "visible" : "hidden"} >
                            <Link className="text-rose-200 hover:text-rose-700 py-2" to="/perfil">Mi perfil</Link>
                            <Link className="text-rose-200 hover:text-rose-700 py-2" to="/listado">Productos</Link>
                            <Link className="text-rose-200 hover:text-rose-700 py-2" to="/proyectos">Proyectos</Link>

                            {categorias.map(cate => (
                                <Link
                                    key={cate._id}
                                    className="text-rose-200 hover:text-rose-700 py-2"
                                    to={`/categoria/${cate._id}`}
                                >
                                    {cate.nombre}
                                </Link>
                            ))}
